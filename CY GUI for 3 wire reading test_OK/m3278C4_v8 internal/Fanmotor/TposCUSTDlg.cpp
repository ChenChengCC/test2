// TposCUSTDlg.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CTposCUSTDlg, CDialog)

CTposCUSTDlg::CTposCUSTDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CTposCUSTDlg::IDD, pParent)
	, m_EDIT_TPOS1(_T(""))
	, m_EDIT_TPOS2(_T(""))
	, m_EDIT_TPOS3(_T(""))
	, m_EDIT_TPOS4(_T(""))
	...
	, m_EDIT_TPOS_ILIMIT_IS(_T(""))
{
	m_pParent=pParent;
}

CTposCUSTDlg::~CTposCUSTDlg()
{
}

void CTposCUSTDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_TPOS_ILIMIT_IS, m_EDIT_TPOS_ILIMIT_IS);
	DDX_Control(pDX, IDC_COMBO_TPOS_ILIMIT_IS, m_COMBO_TPOS_ILIMIT_IS);
}


BEGIN_MESSAGE_MAP(CTposCUSTDlg, CDialog)
	ON_WM_CLOSE()
	ON_WM_NCDESTROY()
	ON_BN_CLICKED(IDC_BUTTON_ReadTPOS, &CTposCUSTDlg::OnBnClickedButtonReadtpos)
END_MESSAGE_MAP()


// CTposCUSTDlg message handlers


void CTposCUSTDlg::OnClose()
{
...
BOOL CTposCUSTDlg::OnInitDialog()
{
...
void CTposCUSTDlg::PostNcDestroy()
{
	// TODO: Add your specialized code here and/or call the base class
	CDialog::PostNcDestroy();
	((CTestDlg*)m_pParent)->tposCUSTdlg = NULL;
    delete this;
}


void CTposCUSTDlg::OnBnClickedButtonReadtpos()
{
...
void CTposCUSTDlg::DisplayIlimitIs(int ilimit_is)
{
	CString errmsg;
	...
	{
		case 0:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("0h: %.2f A"),ilim0);
			break;
		case 1:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("1h: %.2f A"),ilim1);
			break;
		case 2:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("2h: %.2f A"),ilim2);
			break;
		case 3:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("3h: %.2f A"),ilim3);
			break;
		case 4:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("4h: %.2f A"),ilim4);
			break;
		case 5:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("5h: %.2f A"),ilim5);
			break;
		case 6:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("6h: %.2f A"),ilim6);
			break;
		case 7:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("7h: %.2f A"),ilim7);
			break;
		case 8:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("8h: %.2f A"),ilim8);
			break;
		case 9:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("9h: %.2f A"),ilim9);
			break;
		case 0x0a:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("Ah: %.2f A"),ilim10);
			break;
		case 0x0b:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("Bh: %.2f A"),ilim11);
			break;
		case 0x0c:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("Ch: %.2f A"),ilim12);
			break;
		case 0x0d:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("Dh: %.2f A"),ilim13);
			break;
		case 0x0e:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("Eh: %.2f A"),ilim14);
			break;
		case 0x0f:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("Fh: %.2f A"),ilim15);
			break;
		default:
			m_EDIT_TPOS_ILIMIT_IS.Format(_T("-"));
	}
