...
// $Rev: 486 $ $Date: 2007-02-25 14:59:45 -0800 (Sun, 25 Feb 2007) $
//------------------------------------------------------------------------
...
void okCPLL22150::SetReference(double freq, bool extosc)
	{ return(okPLL22150_SetReference(h, freq, from_bool(extosc))); }
...
void okCPLL22393::SetReference(double freq)
	{ return(okPLL22393_SetReference(h, freq)); }
...
//	return((DLL *) LoadLibrary(libname));
	return((DLL *) LoadLibrary(_T(okLIB_NAME)));
	// 
	//LoadLibrary(_T("avr309.dll"))
#else
	DLL *dll;
...
okFrontPanelDLL_GetVersion(char *date, char *time) {
	...
	if (_okFrontPanelDLL_GetVersion)
		return((*_okFrontPanelDLL_GetVersion)(date, time));
}
